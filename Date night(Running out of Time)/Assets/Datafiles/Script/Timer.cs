...
public class Timer : MonoBehaviour
{
    ...
    bool started = false;
    TimerFinishedEvent timerFinished = new TimerFinishedEvent();

    // support for slow motion in game
    float scaletime = 1f;
    #endregion
    ...
    private void Start()
    {
        EventManager.AddSlowMotionListener(SlowMotion);
    }
    /// <summary>
    ...
    void SlowMotion(float scaleTime)
    {
